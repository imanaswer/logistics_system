...
function Login() {
    ...
    const handleLogin = async (e)=>{
        ...
        setError('');
        try {
            console.log("Attempting login to:", `${__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/login/`); // Debugging log
            // 2. Use API_URL here
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$app$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_URL"]}/api/login/`, {
                method: 'POST',
                headers: {
...
//# sourceMappingURL=frontend_f9c61486._.js.map