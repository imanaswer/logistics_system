...
export default function NewJob() {
  ...
  const [vatNumber, setVatNumber] = useState(''); // Added VAT state
  ...
  // Use strings initially to avoid NaN errors while typing
  ...
  const handleSubmit = async (e: any) => {
    ...
    // --- PAYLOAD (Includes VAT and nested client logic) ---
    const payload = {
      job_date: jobDate,
      vat_number: vatNumber, // Job specific VAT
      client: {   
        name: clientName,
        phone: clientPhone || "N/A",
        email: clientEmail || null,
        address: clientAddress || "",
        vat_number: vatNumber // Client Master VAT
      },
