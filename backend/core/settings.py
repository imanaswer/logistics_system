...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'logistics-system-oq8b.onrender.com',  # Your Render backend URL
    '.onrender.com',  # Allow all Render URLs
]

# In production, allow all hosts (Render uses dynamic IPs)
...
if DEBUG:
    ...
    CORS_ALLOWED_ORIGINS = [
        "http://localhost:3000",
        "https://logistics-system-gjsc0axsc-swerr.vercel.app",
        "https://logistics-system-git-main-swerr.vercel.app",
        "https://logistics-system-og8b.onrender.com",
    ]
    
    # Get Vercel URL from environment if provided
    vercel_url = os.environ.get('VERCEL_URL')
    if vercel_url:
        CORS_ALLOWED_ORIGINS.append(f"https://{vercel_url}")
    
    # Allow all Vercel preview deployments (for easier testing)
